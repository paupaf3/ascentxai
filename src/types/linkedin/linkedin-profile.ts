...
export const endorsedSkillSchema = z.object({
    name: z
        .string()
        .describe('Canonical skill name (e.g. "TypeScript", not "TS").'),
    endorsements: z
        .number()
        .nullable()
        .describe("Number of endorsements shown on LinkedIn."),
});
...
export const recommendationSchema = z.object({
    ...
    recommenderTitle: z
        .string()
        .nullable()
        .describe("Title and company of the recommender at the time."),
...
export const volunteerExperienceSchema = z.object({
    ...
    endDate: z
        .string()
        .nullable()
        .describe('YYYY, YYYY-MM, "present", or null.'),
...
export const courseSchema = z.object({
    ...
    associatedWith: z
        .string()
        .nullable()
        .describe("Institution or organization the course is associated with."),
});
...
export const linkedinProfileSchema = z.object({
    ...
    headline: z
        .string()
        .nullable()
        .describe("Professional tagline shown below the name on LinkedIn."),
    location: z.string().nullable(),
    connections: z
        .number()
        .nullable()
        .describe(
            'Approximate connection count (e.g. LinkedIn shows "500+", use 500).'
        ),
    summary: z.string().nullable().describe("About section text."),
    profileUrl: z
        .string()
        .nullable()
        .describe("LinkedIn profile URL if printed in the export."),
    ...
    roles: z
        .array(roleSchema)
        .describe("All professional roles, most recent first."),

    skills: skillsSchema.describe(
        "Aggregated skill taxonomy, normalized and deduplicated."
    ),
    topSkills: z
        .array(z.string())
        .max(5)
    ...
    recommendations: z
        ...
        .describe("Recommendations received section."),
