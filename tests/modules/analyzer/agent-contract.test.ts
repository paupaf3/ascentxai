...
describe("candidateExtractionAgent instructions contract", () => {
    it("uses the correct agent name", async () => {
        const { candidateExtractionAgent } = await import(
            "../../../src/modules/candidate/extraction-agent"
        );
...
describe("linkedinExtractionAgent instructions contract", () => {
    it("uses the correct agent name", async () => {
        const { linkedinExtractionAgent } = await import(
            "../../../src/modules/linkedin/extraction-agent"
        );
        expect(linkedinExtractionAgent.name).toBe(
...
describe("jobExtractionAgent instructions contract", () => {
    it("uses the correct agent name", async () => {
        const { jobExtractionAgent } = await import(
            "../../../src/modules/job/extraction-agent"
        );
...
describe("careerAnalysisAgent instructions contract", () => {
    it("uses the correct agent name", async () => {
        const { careerAnalysisAgent } = await import(
            "../../../src/modules/analyzer/analysis-agent"
        );
    ...
    it("instructs to use tools only when context is insufficient", async () => {
        ...
        expect(instructions).toContain("only when the provided context is clearly insufficient");
